document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderMainUI() {
    ...
    const toggleBtnClass = isLoading ? 'toggle-btn loading' : `toggle-btn ${isActive ? 'active' : ''}`;
    const toggleIconContent = isLoading ? '⟳' : (isActive ? '●' : '○');
    const toggleTextContent = isLoading ? 'ĐANG XỬ LÝ' : (isActive ? 'TẮT' : 'BẬT');
      ...
      <div class="main-card">
        ...
        <div class="main-content">
          <div class="config-section">
            ...
            <div class="config-group">
              ...
              <div class="proxy-container">
                <input 
                  type="text"
                  class="key-input current-proxy ${currentProxyInfo.includes('Lỗi') ? 'error-proxy' : ''}" 
            ...
            <div class="config-actions">
              <button class="save-btn" id="save-config-btn" ${isLoading ? 'disabled' : ''}>
                Lưu cấu hình
              </button>
              <button class="open-btn" id="open-extension-btn" ${isLoading ? 'disabled' : ''}>
          ...
          <div class="toggle-container">
            <button class="${toggleBtnClass}" id="toggle-btn" ${isLoading ? 'disabled' : ''}>
              <span class="toggle-icon ${isLoading ? 'loading-icon' : ''}">${toggleIconContent}</span>
  ...
  function handleToggleActive() {
    ...
    chrome.runtime.sendMessage({
      ...
      if (response && response.success) {
        ...
        alert('Không thể ' + (newActiveState ? 'bật' : 'tắt') + ' proxy: ' + (response?.error || 'Lỗi không xác định'));
      }
  ...
  chrome.storage.sync.get(['proxyKey', 'rotationTime', 'proxyType', 'autoAssign', 'isActive', 'isp', 'province', 'currentProxyInfo', 'proxyData'], function(result) {
